...
export class NfcWhereQuestion implements Question {
    public answer: string = "NFC 2018 is at Scandic Infra City, Stockholm, Sweden.\n" +
        "Full address:\n" +
        "Scandic Infra City\n" +
        "Kanalvägen 10\n" +
    ...
    public keyword: string = "nfc_where";

    public questions: string[] = [
        "Where is NFC?",
        "Where is NFC 2018?",
        "Where is Nordic FuzzCon?",
        "Where is NordicFuzzCon?",
        "Where is the con?",
        "Where is it?",
        "Where is the hotel?",
    ];
