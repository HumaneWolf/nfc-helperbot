...
export class NearbyEatingQuestion implements Question {
    public answer: string = "The Main Hotel has a restaurant and a bar. In addition, there is a Subway right by the " +
    ...
    public keyword: string = "area_eating";
